...
private:
    ...
    void increasing_motor_speed() { cout << "Increasing motor speed in elec_engine." << endl; };
    void decreasing_motor_speed() { cout << "Decreasing motor speed in elec_engine." << endl; };
};
